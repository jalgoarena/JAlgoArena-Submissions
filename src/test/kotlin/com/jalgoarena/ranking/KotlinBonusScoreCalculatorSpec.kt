...
class KotlinBonusScoreCalculatorSpec {
    ...
    fun returns_150_percent_of_normal_score_for_kotlin() {
        ...
        given(calculator.calculate(userSubmission, Problem("fib", 1, 1))).willReturn(10.0)

        val kotlinBonusScoreCalculator = KotlinBonusScoreCalculator(calculator)
        val score = kotlinBonusScoreCalculator.calculate(userSubmission, Problem("fib", 1, 1))
    ...
    fun returns_unchanged_score_for_non_kotlin_language() {
        ...
        given(calculator.calculate(userSubmission, Problem("fib", 1, 1))).willReturn(initialScore)
